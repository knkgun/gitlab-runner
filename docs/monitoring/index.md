...
You will need to [restart the runner service](../commands/index.md#gitlab-runner-restart) if you have added the address to your `config.toml` file to start the metrics HTTP server.
